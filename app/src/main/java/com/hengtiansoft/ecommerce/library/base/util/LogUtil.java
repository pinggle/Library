...
public class LogUtil {
    ...
    private static final String TAG_PREFIX = BuildConfig.TAG;

    public static final boolean isSaveLog = true;// 是否把保存日志到SD卡中
    public static final String LOG_PATH = Environment.getExternalStorageDirectory().getPath() + "/ecommercelibrary2016"; //
    // SD卡中的根目录
    ...
    public static boolean allowD = BuildConfig.allowD;
    public static boolean allowE = BuildConfig.allowE;
    public static boolean allowI = BuildConfig.allowI;
    public static boolean allowV = BuildConfig.allowV;
    public static boolean allowW = BuildConfig.allowW;
    public static boolean allowWtf = BuildConfig.allowWtf;
    ...
    /**
     * 自定义的logger,交由baseActivity实现
     */
    public static CustomLogger customLogger;

    public static void setCustomLogger(CustomLogger pCustomLogger) {
        customLogger = pCustomLogger;
    }
