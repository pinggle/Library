...
public class CrashHandler implements Thread.UncaughtExceptionHandler {
    ...
    public void collectDeviceInfo(Context ctx) {
        try {
            ...
            LogUtil.e("CrashHandler.NameNotFoundException---> error occured when collect package info\r\n" + e
                    .getMessage());
        }
        ...
        for (Field field : fields) {
            try {
                ...
                LogUtil.e("CrashHandler.NameNotFoundException---> an error occured when collect crash info\r\n" + e
                        .getMessage());
            }
        }
    }
