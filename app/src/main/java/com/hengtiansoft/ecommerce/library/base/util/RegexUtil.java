 ...
 *
 * @author liminghuang
 * @time 6/15/2016 16:47
 * Modifier：liminghuang
 * ModifyTime：6/15/2016 16:47
 * Comment：
 */
public final class RegexUtil {
    ...
    public static boolean checkZh(String args) {
        String regex = "^[\\u4e00-\\u9fa5]{0,}$";//编码格式ISO-8859-1
    ...
    public static boolean checkDate(String arg) {
        String regex = "^(?:(?!0000)[0-9]{4}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-8])|(?:0[13-9]|1[0-2])-" +
                "(?:29|30)|(?:0[13578]|1[02])-31)|(?:[0-9]{2}(?:0[48]|[2468][048]|[13579][26])|" +
                "(?:0[48]|[2468][048]|[13579][26])00)-02-29)$^(?:(?!0000)[0-9]{4}-(?:(?:0[1-9]|1[0-2])-" +
                "(?:0[1-9]|1[0-9]|2[0-8])|(?:0[13-9]|1[0-2])-(?:29|30)|(?:0[13578]|1[02])-31)|(?:[0-9]{2}" +
                "(?:0[48]|[2468][048]|[13579][26])|(?:0[48]|[2468][048]|[13579][26])00)-02-29)$^(?:(?!0000)[0-9]{4}-" +
    ...
    public static boolean checkIp(String ipAddress) {
        String regex = "\\\\b(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\\\\.){3}" +
