package com.hengtiansoft.ecommerce.library.view.layout;
...
import com.hengtiansoft.ecommerce.library.base.RxManager;
import com.hengtiansoft.ecommerce.library.base.util.LogUtil;
import com.hengtiansoft.ecommerce.library.data.Data;
import com.hengtiansoft.ecommerce.library.view.viewholder.CommFooterVH;
...
public class TRecyclerView<T extends BaseEntity.ListBean> extends LinearLayout {
    ...
    private void initView(Context context) {
        ...
        mRxManager.on(Constants.EVENT_UPDATE_ITEM, (arg0) -> mCommAdapter.upDateItem(((UpDateData) arg0).i, (
                (UpDateData) arg0).oj));
    ...
    public class CoreAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public void setBeans(List<T> datas, int begin) {
            ...
            this.isHasMore = datas.size() >= Constants.PAGE_COUNT;
            if (begin > 1) {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            try {
                ...
                return (RecyclerView.ViewHolder) (viewType == mHeadViewType ? mHeadViewClass.getConstructor(View
                        .class).newInstance(
                        LayoutInflater.from(parent.getContext()).inflate(mHeadViewType, parent, false))
                        : (RecyclerView.ViewHolder) (isFoot ? mFooterViewClass : mItemViewClass)
                        .getConstructor(View.class).newInstance(LayoutInflater.from(parent.getContext())
                                .inflate(isFoot ? mFooterViewType : viewtype, parent, false)));
            } catch (Exception e) {
                LogUtil.e("onCreateViewHolder十有八九是xml写错了,哈哈", e);
                return null;
            }
        }
