...
public final class Base64 {
    ...
    private static final int TWENTY_FOUR_BITGROUP = 24;
    ...
    public static String encode(byte[] binaryData) {
        ...
        int fewerThan24bits = lengthDataBits % TWENTY_FOUR_BITGROUP;
        int numberTriplets = lengthDataBits / TWENTY_FOUR_BITGROUP;
